...
func (c *CLI) Run(ctx context.Context, args ...string) error {
	...
	cli.Flag("chdir", "change the working directory").Short('C').String(&cmd.Dir).Default(cmd.Dir)
	...
	// 	{ // $ bud tool v8
	// 		cmd := toolv8.New(c.bud.Stdin, c.bud.Stdout)
