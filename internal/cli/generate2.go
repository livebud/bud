...
func (g *generatorGenerator) GenerateFile(fsys genfs.FS, file *genfs.File) error {
	...
	middlewareImportPath := g.module.Import("generator/middleware")
	sessionImportPath := g.module.Import("generator/session")
	generators := []*Generator{
		{
			Import: &imports.Import{
		...
		{
			Import: &imports.Import{
				Name: imset.Add(middlewareImportPath),
				Path: middlewareImportPath,
			},
			Path:  "bud",
			Camel: "middleware",
			Type:  "Generator",
		...
		{
			Import: &imports.Import{
				Name: imset.Add(sessionImportPath),
				Path: sessionImportPath,
			},
			Path:  "bud",
			Camel: "session",
			Type:  "Generator",
