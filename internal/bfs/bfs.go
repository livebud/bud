...
func Load(flag *framework.Flag, log log.Log, module *gomod.Module) (*FS, error) {
	...
	// svelte.New(fsys, log, module, transformer, vm)
	// vm, err := v8.Load()
	// if err != nil {
	// 	return nil, err
	// }
	...
	// view := view.New(module, transforms, flag)
	...
	// fsys.FileGenerator("bud/internal/web/view/view.go", view)
	// fsys.ServeFile("bud/view", view.ServeFile)
