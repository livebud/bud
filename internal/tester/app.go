...
func (a *App) Run(ctx context.Context, args ...string) (stdout string, stderr string, err error) {
	cmd := exec.CommandContext(ctx, "bud/app", args...)
	cmd.Dir = a.dir
...
// func (a *App) Start(ctx context.Context, dir string, args ...string) (*Process, error) {
// 	cmd := exec.CommandContext(ctx, "bud/app", args...)
// 	cmd.Dir = dir
