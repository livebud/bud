...
example.basic:
	...
	@ go run cmd/bud/main.go -C example/basic run
...
example.scratch:
	...
	@ go run cmd/bud/main.go create --link=true example/scratch
	@ go run cmd/bud/main.go -C example/scratch new controller / index show
	@ go run cmd/bud/main.go -C example/scratch new controller users/admin:admin index show
	@ (cd example/scratch && npm link ../../livebud)
	@ go run cmd/bud/main.go -C example/scratch run
...
example.hn:
	...
	@ go run cmd/bud/main.go -log=debug -C example/hn run

example.hn.embed:
	@ (cd example/hn && npm link ../../livebud)
	@ go run cmd/bud/main.go -C example/hn build --embed
