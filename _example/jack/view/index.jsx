          ...
          <div className="right">
            ...
            <div class="feature-list">
              <div className="feature-inner">
                <div class="feature">
                  <img src="/checkmark-green.svg" />5 minute setup
                </div>
                <div class="feature">
                  <img src="/checkmark-green.svg" />
                  Remote ready
                </div>
                <div class="feature">
                  <img src="/checkmark-green.svg" />
        ...
        <li className="item">
          ...
          <div className="right">
            <div className="image-container">
              <img src="/create-standup.png" alt="create standup" />
            </div>
          </div>
        </li>
        <li className="item">
          ...
          <div className="right">
            <div className="image-container">
              <img src="/give-update.png" alt="give update" />
            </div>
          </div>
        </li>
        <li className="item">
          ...
          <div className="right">
            <div className="image-container">
              <img src="/post-standup.png" alt="post standup" />
            </div>
          </div>
        </li>
