...
var main = gotemplate.MustParse("framework/generator/main.gotext", template)
...
func (g *generate) GenerateFile(ctx context.Context, fsys overlay.F, file *overlay.File) error {
