...
func TestGenerators(t *testing.T) {
	...
	td.Files["generator/tailwind/tailwind.go"] = `
		...
		func (g *Generator) GenerateDir(ctx context.Context, fsys *budfs.FS, dir *budfs.Dir) error {
			dir.GenerateFile("tailwind.css", func(ctx context.Context, fsys *budfs.FS, file *budfs.File) error {
				file.Data = []byte("/** tailwind **/")
				return nil
			})
			dir.GenerateFile("preflight.css", func(ctx context.Context, fsys *budfs.FS, file *budfs.File) error {
	...
	td.Files["generator/markdoc/markdoc.go"] = `
		...
		func (g *Generator) compile(ctx context.Context, fsys *budfs.FS, file *budfs.File) error {
	...
	td.Files["generator/web/viewer/viewer.go"] = `
		...
		func (g *Generator) GenerateDir(ctx context.Context, fsys *budfs.FS, dir *budfs.Dir) error {
			dir.GenerateFile("viewer.go", func(ctx context.Context, fsys *budfs.FS, file *budfs.File) error {
