...
func New(exec *exe.Template, flag *framework.Flag, injector *di.Injector, log log.Log, module *gomod.Module) *Generator {
	return &Generator{exec, flag, injector, log, module}
}
